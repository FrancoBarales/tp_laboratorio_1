...
int main(void){
	...
	do{
		...
		switch(opcion){
			case 1:
				getFloat(&kilometros, "\nIngresar cantidad de kilometros (100 o mas): ", "Error. cantidad invalida de kilometros.", 10000, 100, 5);
				flag1 = TRUE; // si se ingresaron correctamente los kilometros, se levanta la primera flag.
				break;
			case 2:
				getFloat(&precioAerolineas, "\nIngresar precio del pasaje de Aerolineas (entre $1.000.000 y $20.000): ", "Error. Precio invalido. ", 100000000, 20000, 5);
				getFloat(&precioLatam, "\nIngresar precio del pasaje de Latam (entre $1.000.000 y $20.000): ", "Error. Precio invalido. ", 100000000, 20000, 5);
